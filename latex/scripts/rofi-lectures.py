...
sorted_lectures = lectures#sorted(lectures, key=lambda l: -l.number)
...
if key == 0:
    if index == 0:
        lectures.update_lectures_in_master([index+1])
    else :
        lectures.update_lectures_in_master([index, index+1])
